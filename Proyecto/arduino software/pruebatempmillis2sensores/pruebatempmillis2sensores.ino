           ...
           for(i=0;i<=1;i++)
            {
              ...
              myFile.print("Temperatura Sensor ");
              myFile.print(i);
              myFile.print(": ");
              ...
              myFile.println(val);  //Mostramos por puerto serie el valor de la temperatura leida
              if (val<tempmin)
              tempmin=val;
              if (val>tempmax)
              tempmax=val;
            ...
            myFile.print("La temperatura media es: ");  //Mostramos la temperatura media de todas las temperaturas
            myFile.println(media);
            myFile.print("La temperatura minima registrada es: ");  //Mostramos la temperatura minima registrada
            myFile.println(tempmin);
            myFile.print("La temperatura maxima registrada es: ");  //Mostramos la temperatura maxima registrada
            myFile.println(tempmax);
            myFile.println();
