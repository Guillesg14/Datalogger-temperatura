...
long intervalomedidas  = 3600000;               //intervalo entre cada una de las medidas
          ...
          { 
           ...
           for(i=0;i<=1;i++)
            ...
            media=media/i;                                        //Calculamos la media de las temperaturas
              ...
              if(millisactuales3 - millisanteriores3>intervalomedidas)         //diferencia del intervalo marcado
              {
