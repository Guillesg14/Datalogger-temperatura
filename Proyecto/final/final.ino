...
int pinled = 34;                           //led leer temperaturas
int pinled2 = 35;                          //led pausa lectura
int pinboton = 36;                         //pin interruptor inicio/parar tomas
int valorboton = 0;       
long intervalo = 5000;                   
...
pinMode(34, OUTPUT);       //
pinMode(35, OUTPUT);       //pines leds y botones
pinMode(36, INPUT);        //
...
/////////////////////////////////////////////////////////////////////////////////////////////
  ...
  /* dianumero, diasemana, mes, siglo(0siempre), año */
   //rtc.setDate(14, 3, 6, 0, 17);
   
  /* hr, min, sec */
  //rtc.setTime(19, 20, 00);                                        /////poner en hora el reloj
